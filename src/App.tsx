...
const EXP_TEST_PROJECT: StoryProject = {
  ...
  scenes: [
    {
      id: 'exp-scene-1',
      scriptSegment: '아버님, 이 소금... 정말 아버님이 만드신 건가요?',
      imagePrompt: '한국 전통 소금밭, 노년 남성, 저녁노을',
      imageUrl: 'https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=960&h=544&fit=crop',
      audioUrl: null,
      videoUrl: null,
      status: 'done',
      audioStatus: 'idle',
    ...
    },
    {
      ...
      imagePrompt: '한국 드라마 실내 장면, 감정적인 대화, 중년 여성',
      imageUrl: 'https://images.unsplash.com/photo-1519710164239-da123dc03ef4?w=960&h=544&fit=crop',
      audioUrl: null,
      videoUrl: null,
      status: 'done',
      audioStatus: 'idle',
    ...
    {
      id: 'exp-scene-3',
      scriptSegment: '50년이다... 나는 50년 동안 이 거짓말을 지켜왔어.',
      imagePrompt: '노인의 손, 소금 결정체, 클로즈업',
      imageUrl: 'https://images.unsplash.com/photo-1464226184884-fa280b87c399?w=960&h=544&fit=crop',
      audioUrl: null,
      videoUrl: null,
      status: 'done',
      audioStatus: 'idle',
