...
import { StyleDescModal } from './components/modals/StyleDescModal';
    ...
    <div className={`min-h-screen bg-[#FDFDFD] dark:bg-slate-950 text-slate-800 dark:text-slate-100 font-sans selection:bg-indigo-100 dark:selection:bg-indigo-900 pb-40 transition-colors duration-500`}>
      ...
      {isRegenerateModalOpen && (
        <RegenerateModal
          ...
          setRegenerateInput={setRegenerateInput}
          onRegenerate={handleRegenerateWithModification}
      ...
      {isStyleDescModalOpen && (
        <StyleDescModal
          ...
          onChange={setNewStyleDescription}
          onClose={() => setIsStyleDescModalOpen(false)}
        />
      )}
