...
export const styleTemplates: StyleTemplate[] = [
  ...
  { id: 'modern-anime', category: '애니메이션', name: '모던 애니메이션', thumbnail: '/templates/modern-anime.webp', imagePromptPrefix: 'Modern anime style, detailed backgrounds, cel-shaded,', negativePrompt: 'realistic, 3d, photo' },
